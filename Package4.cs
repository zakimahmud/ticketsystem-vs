...
{
    public partial class Package4 : Form
    {
        public Package4()
        {
            InitializeComponent();
        ...
        private void Package4_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'loginDataSet9.Ticket' table. You can move, or remove it, as needed.
            //this.ticketTableAdapter.Fill(this.loginDataSet9.Ticket);
            // TODO: This line of code loads data into the 'loginDataSet1.Ticket_entry' table. You can move, or remove it, as needed.
            //this.ticket_entryTableAdapter.Fill(this.loginDataSet1.Ticket_entry);
