...
{
    public partial class Package5 : Form
    {
        public Package5()
        {
            InitializeComponent();
        ...
        private void Package5_Load(object sender, EventArgs e)
        {
            //// TODO: This line of code loads data into the 'loginDataSet10.Ticket' table. You can move, or remove it, as needed.
            //this.ticketTableAdapter.Fill(this.loginDataSet10.Ticket);
            //// TODO: This line of code loads data into the 'loginDataSet.Ticket_entry' table. You can move, or remove it, as needed.
            //this.ticket_entryTableAdapter.Fill(this.loginDataSet.Ticket_entry);

            int a;
            
            con.Open();
            string query = "Select Max(Serial_no) from Ticket_entry";
