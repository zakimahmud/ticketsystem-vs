...
{
    public partial class Package2 : Form
    {
        public Package2()
        {
            InitializeComponent();
        ...
        private void Package2_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'loginDataSet8.Ticket' table. You can move, or remove it, as needed.
            //this.ticketTableAdapter.Fill(this.loginDataSet8.Ticket);
            // TODO: This line of code loads data into the 'loginDataSet3.Ticket_entry' table. You can move, or remove it, as needed.
            //this.ticket_entryTableAdapter.Fill(this.loginDataSet3.Ticket_entry);
